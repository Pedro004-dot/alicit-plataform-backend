...
import type { AISpanType, AISpan, AISpanOptions, AITracingInstanceConfig, AISpanProcessor, AnyAISpan } from './types.js';
...
export declare const aiTracingDefaultConfig: AITracingInstanceConfig;
