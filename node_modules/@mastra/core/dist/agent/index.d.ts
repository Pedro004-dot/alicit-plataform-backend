...
import type { ScorerRunInputForAgent, ScorerRunOutputForAgent, MastraScorers } from '../scores/index.js';
...
export { TripWire };
export { MessageList };
export { convertMessages } from './message-list/index.js';
export type { OutputFormat } from './message-list/index.js';
export * from './types.js';
export type { AgentExecutionOptions, InnerAgentExecutionOptions } from './agent.types.js';
...
export declare class Agent<TAgentId extends string = string, TTools extends ToolsInput = ToolsInput, TMetrics extends Record<string, Metric> = Record<string, Metric>> extends MastraBase {
    ...
    __primitive({ instructions, messages, context, thread, memoryConfig, resourceId, runId, toolsets, clientTools, runtimeContext, saveQueueManager, writableStream, methodType, tracingContext, }: {
        instructions: string;
