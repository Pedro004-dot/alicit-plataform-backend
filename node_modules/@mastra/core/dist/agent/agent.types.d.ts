...
import type { LoopConfig, LoopOptions } from '../loop/types.js';
...
export type InnerAgentExecutionOptions<OUTPUT extends OutputSchema | undefined = undefined, FORMAT extends 'aisdk' | 'mastra' | undefined = undefined> = AgentExecutionOptions<OUTPUT, any, FORMAT> & {
