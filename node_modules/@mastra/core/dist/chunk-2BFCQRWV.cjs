...
var MastraScorer = class _MastraScorer {
  ...
  toMastraWorkflow() {
    const workflowSteps = this.steps.map((scorerStep) => {
      return chunk7GYN2OE3_cjs.createStep({
        id: scorerStep.name,
    ...
    const workflow = chunk7GYN2OE3_cjs.createWorkflow({
  ...
  async executePromptStep(scorerStep, tracingContext, context) {
    ...
    const judge = new chunk7GYN2OE3_cjs.Agent({ name: "judge", model, instructions });
...
function isWorkflow(target) {
  return target instanceof chunk7GYN2OE3_cjs.Workflow;
}
...
//# sourceMappingURL=chunk-2BFCQRWV.cjs.map
//# sourceMappingURL=chunk-2BFCQRWV.cjs.map