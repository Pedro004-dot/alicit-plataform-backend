...
var NewAgentNetwork = class extends chunkKXCUCBEI_cjs.MastraBase {
  ...
  async getRoutingAgent({ runtimeContext }) {
    ...
    const instructions = `
        ...
        `;
    return new chunkEZCMCWSC_cjs.Agent({
      name: "routing-agent",
      instructions,
      model: this.#model,
      memory: memoryToUse,
  ...
  async loop(messages, {
    ...
    const finalStep = chunkEZCMCWSC_cjs.createStep({
      id: "final-step",
    ...
    const mainWorkflow = chunkEZCMCWSC_cjs.createWorkflow({
  ...
  createWorkflow({ runtimeContext }) {
    ...
    const routingStep = chunkEZCMCWSC_cjs.createStep({
      id: "routing-step",
      inputSchema: zod.z.object({
        task: zod.z.string(),
        resourceId: zod.z.string(),
...
${completionResult.object.finalResult}` : ""}
    ...
    const agentStep = chunkEZCMCWSC_cjs.createStep({
      id: "agent-step",
      inputSchema: zod.z.object({
        task: zod.z.string(),
        resourceId: zod.z.string(),
      ...
      execute: async ({ inputData, [chunkNFXTYMWZ_cjs.EMITTER_SYMBOL]: emitter, getInitData }) => {
    ...
    const workflowStep = chunkEZCMCWSC_cjs.createStep({
      id: "workflow-step",
      inputSchema: zod.z.object({
        task: zod.z.string(),
        resourceId: zod.z.string(),
    ...
    const toolStep = chunkEZCMCWSC_cjs.createStep({
      id: "toolStep",
      inputSchema: zod.z.object({
        task: zod.z.string(),
        resourceId: zod.z.string(),
    ...
    const finishStep = chunkEZCMCWSC_cjs.createStep({
      id: "finish-step",
      inputSchema: zod.z.object({
        task: zod.z.string(),
        resourceId: zod.z.string(),
    ...
    const networkWorkflow = chunkEZCMCWSC_cjs.createWorkflow({
