...
export type InferSchemaOutput<OUTPUT extends OutputSchema> = OUTPUT extends undefined ? undefined : OUTPUT extends z4.ZodType<infer OBJECT, any> ? OBJECT : OUTPUT extends z3.Schema<infer OBJECT, z3.ZodTypeDef, any> ? OBJECT : OUTPUT extends Schema<infer OBJECT> ? OBJECT : unknown;
export type OutputSchema<OBJECT = any> = z4.ZodType<OBJECT, any> | z3.Schema<OBJECT, z3.ZodTypeDef, any> | Schema<OBJECT> | undefined;
...
export declare function getResponseFormat(schema?: OutputSchema | undefined): {
    type: 'text';
} | {
    type: 'json';
    /**
