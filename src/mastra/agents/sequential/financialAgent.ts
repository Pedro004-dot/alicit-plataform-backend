...
import { financialAgentModel } from "../../config/modelFallback";
...
`;
  ...
  model: financialAgentModel, // 🔧 FALLBACK: gpt-4o → gpt-4o-mini → gpt-3.5-turbo
  tools: {
    "financial-licitacao-search": contextualFinancialTool
  },
