...
import { EditalDocument } from "../../../../repositories/editalRAGRepository";
import { EditalAnalysisRequest } from "../../../../services/edital/RAGService";

export async function processDocuments(request: EditalAnalysisRequest): Promise<EditalDocument[]> {
  const pdfProcessor = new PDFProcessorAdapter();
  const editalDocuments: EditalDocument[] = [];
