...
const uploadDocumento = async (req: Request, res: Response) => {
    try {
        ...
        const documento = await empresaRepository.uploadDocumento(
            empresaId,
            file.buffer,
            nomeDocumento,
            dataExpiracao
...
const updateStatusDocumento = async (req: Request, res: Response) => {
    try {
        const { documentoId } = req.params;
