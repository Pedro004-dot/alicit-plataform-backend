...
import { EmpresaInput } from "./createEmpresaController";

const atualizarEmpresa = async (req: Request, res: Response) => {
    try {
        const { empresaId } = req.params;
        const empresaData: Partial<EmpresaInput> = req.body;
...
const atualizarDadosBancarios = async (req: Request, res: Response) => {
    try {
        const { empresaId } = req.params;
...
const buscarEmpresaCompleta = async (req: Request, res: Response) => {
    try {
        const { empresaId } = req.params;
...
const buscarEmpresaPorCnpj = async (req: Request, res: Response) => {
    try {
