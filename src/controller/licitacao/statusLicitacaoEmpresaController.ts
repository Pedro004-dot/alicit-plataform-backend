...
const atualizarStatus = async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
...
const listarTodas = async (req: Request, res: Response) => {
  try {
...
const buscarUma = async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
...
const atualizarStatusPorChaves = async (req: Request, res: Response) => {
  try {
...
const deletarPorStatus = async (req: Request, res: Response) => {
  try {
    ...
    await licitacaoEmpresaService.deletarPorStatus(statusList);
    res.status(200).json({ 
      success: true, 
...
export default { criar, atualizarStatus, atualizarStatusPorChaves, listarTodas, buscarUma, deletar, deletarPorStatus };