...
export class LicitacaoDocumentosController {
    ...
    async gerarPreview(req: Request, res: Response): Promise<void> {
        try {
    ...
    async downloadDocumento(req: Request, res: Response): Promise<void> {
        try {
            const { documentoId } = req.params;
    ...
    async verificarExistencia(req: Request, res: Response): Promise<void> {
        try {
            const { numeroControlePNCP } = req.params;
