...
export class RelatoriosController {
    ...
    async listarRelatoriosEmpresa(req: Request, res: Response): Promise<void> {
        try {
    ...
    async buscarRelatorio(req: Request, res: Response): Promise<void> {
        try {
    ...
    async downloadRelatorio(req: Request, res: Response): Promise<void> {
        try {
    ...
    async gerarUrlDownload(req: Request, res: Response): Promise<void> {
        try {
            const { relatorioId } = req.params;
    ...
    async verificarRelatorioExistente(req: Request, res: Response): Promise<void> {
        try {
            const { empresaCNPJ, numeroControlePNCP } = req.params;
